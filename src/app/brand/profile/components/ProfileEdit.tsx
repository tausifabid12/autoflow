...
// === Dummy options (replace as needed) ===
const roleOptions = [
  { value: "creator", label: "Creator", description: "Influencer or content creator" },
  { value: "brand", label: "Brand", description: "Business or organization" },
];
