...
const { data, isLoading, error, refetch } = useQuery({
  ...
  const getStatusColor = (status: string) => {
    const colors: Record<string, { bg: string; text: string; border: string }> = {
      completed: { bg: 'bg-emerald-700/20', text: 'text-emerald-700', border: 'border-emerald-700/30' },
      pending: { bg: 'bg-amber-700/20', text: 'text-amber-700', border: 'border-amber-700/30' },
      failed: { bg: 'bg-rose-700/20', text: 'text-rose-700', border: 'border-rose-700/30' },
      refunded: { bg: 'bg-blue-700/20', text: 'text-blue-700', border: 'border-blue-700/30' },
    }
  ...
  const getTypeColor = (type: string) => {
    const colors: Record<string, { bg: string; text: string }> = {
      payment: { bg: 'bg-cyan-700/10', text: 'text-cyan-700' },
      subscription: { bg: 'bg-blue-700/10', text: 'text-blue-700' },
      refund: { bg: 'bg-orange-700/10', text: 'text-orange-700' },
    }
